...
public class EmployeeAccessEligibility {
    ...
    public static class Employee {
        ...
        public Employee(String employeeId, String name, int age,
            ...
            if (!employmentType.equalsIgnoreCase("Active")
                ...
                throw new IllegalArgumentException("Employment type must be Active or Inactive");

            if (securityClearanceLevel < 0 || securityClearanceLevel > 5)
                throw new IllegalArgumentException("Security clearance must be between 0 and 5");

            if (requestedAccessLevel < 0 || requestedAccessLevel > 5)
                throw new IllegalArgumentException("Requested access level must be between 0 and 5");
    ...
    public static void main(String[] args) {
        ...
        employees.add(new Employee(
                "EMP103", "Arun", 19,
                "Sales", "Inactive", 1, false, 4));

        employees.add(new Employee(
                "EMP104", "Meena", 30,
                "Finance", "Active", 1, true, 3));
